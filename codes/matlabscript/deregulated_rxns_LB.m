...
out_file=strcat('/Users/vikash/Documents/MATLAB/eatp_metabolism/results/modelSim/','LB_rxns_enrichment.txt')
DEflag=2;

DEitem=model.rxns(xx);

subSystemEnrichment(model,DEitem,out_file,DEflag)
writematrix([ctl_fluxes eatp_fluxes],'/Users/vikash/Documents/MATLAB/eatp_metabolism/results/modelSim/LB_flux_data.txt','Delimiter','tab')
pvals=pvals';
...
writetable(T,'/Users/vikash/Documents/MATLAB/eatp_metabolism/results/modelSim/LB_rxn_pvals_kstest.txt','Delimiter','tab');
...
% 
% see=[ctl_fluxes(adj_p<cut,:) eatp_fluxes(adj_p<cut,:)];
% 
% xx=find(adj_p<cut);
% 
% %%
% boxplot([ctl_fluxes(xx(1),:)',eatp_fluxes(xx(1),:)'])
