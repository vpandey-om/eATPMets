...
load(fullfile(modelFolder,'M9iML1515.mat'))
iML1515=model;
% get match experimental metabolite data to models 
load(fullfile(matFolder,'M9_dereg_mets.mat'))
...
load(fullfile(matFolder,'M9_genes.mat'))
geneData=M9ST2018Summaryreduced;
...
%% 
save(fullfile(matFolder,'M9datamodels'),'regMets','regMetRatio','model_genes','model_gene_ratios','dereg_rxns','dereg_rxnFC')
...
path_save=fullfile(matFolder,'M9_alternative.mat')
